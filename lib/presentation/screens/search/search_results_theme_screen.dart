...
import 'package:youscribe/presentation/screens/search/widgets/search_theme_options_view.dart';
...
class SearchResultsThemeScreen extends StatefulWidget {
  const SearchResultsThemeScreen({required this.params, super.key});

  final SearchResultScreenParams? params;

  @override
  State<SearchResultsThemeScreen> createState() =>
      _SearchResultsThemeScreenState();
}

class _SearchResultsThemeScreenState extends State<SearchResultsThemeScreen> {
            ...
            ? ListView(
                ...
                children: [
                  ...List.generate(selection.products.length, (index) {
                    final product = selection.products[index];
                    const Stream<DownloadProgressWithStatus>
                        downloadProgressStream = Stream.empty();
                    ...
                    return ProductInfoView(
                      ...
                      productWidget: ProductView(
                        ...
                        downloadProgressStream: downloadProgressStream,
                      ),
                    );
                  })
                ],
    ...
    return Center(
      ...
      children: [
        SearchThemeOptionsView(
          ...
          sortOption: state.sortOption ?? SortOption.mostRead,
        ),
        Expanded(
            child: SizedBox(
                ...
                : Container(
                    ...
                    child: SingleChildScrollView(
                      child: Column(children: [
                        ...state.selections.map(_selectionsView),
                      ]),
                    ),
                  ),
          ),
