...
class GetAuthorsFollowedUseCase
    extends AsyncUseCase<void, List<FollowItemEntity>>
    with Debuggable, Loggable {
  GetAuthorsFollowedUseCase(UserAccountRepository userAccountRepository)
      : _userAccountRepository = userAccountRepository;

  final UserAccountRepository _userAccountRepository;

  @override
  String get debugName => 'GetAuthorsFollowedUseCase';

  @override
  // ignore: avoid_renaming_method_parameters
  FutureOrResult<List<FollowItemEntity>> execute(void params) async {
    try {
      final followers = await _userAccountRepository.getAuthorsFollowed();
      return Ok(followers);
    } on APIRequestException catch (e) {
      logError("Error getting author's followed : $e", error: Exception(e));
      return Err(e);
    } catch (e) {
      logError("Error getting author's followed : $e", error: Exception(e));
      rethrow;
