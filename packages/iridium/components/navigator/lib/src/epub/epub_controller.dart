  ...
  void onSkipLeft({bool animated = true}) {
    ...
    if (pageController != null) {
      if (animated) {
        ...
        Fimber.d("page: $page");
        //NOTE: This is where navigation to the previous page is made.
        pageController.jumpToPage(page);
        //The old Way I (Damien) did to get the current page and swipe to it.
        // if (onPageSwiped != null && page > -1) {
        //   onPageSwiped!(page + 1);
        // }
      }
    ...
    if (pageController != null) {
      if (animated) {
        ...
        int page =
            (pageController.page ?? 0).round() + (isReverseOrder ? -1 : 1);
        Fimber.d("page: $page");
        //NOTE: This is where navigation to the next page is made.
        pageController.jumpToPage(page);
        //The old Way I (Damien) did to get the current page and swipe to it.
        // if (onPageSwiped != null && page > -1) {
        //   onPageSwiped!(page + 1);
