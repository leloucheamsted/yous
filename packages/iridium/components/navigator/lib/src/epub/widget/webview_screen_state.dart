...
class WebViewScreenState extends State<WebViewScreen> {
  ...
  late WebViewPanGestureRecognizer webViewPanGestureRecognizer;
  ...
  void initState() {
    ...
    webViewPanGestureRecognizer = WebViewPanGestureRecognizer(
  ...
  Widget buildWebViewComponent(Link link) => isLoaded
      ? InAppWebView(
          ...
          initialSettings: InAppWebViewSettings(
            ...
            decelerationRate: Platform.isIOS ? ScrollViewDecelerationRate.FAST : ScrollViewDecelerationRate.NORMAL
          ),
          ...
          gestureRecognizers: {
            Factory<WebViewPanGestureRecognizer>(
                () => webViewPanGestureRecognizer),
  ...
  void _updateSpineItemPosition(CurrentSpineItemState state) {
    ...
    int lastPosition = state.spineItemIdx;
    if (widget.publicationController.pageChangeHistory.length > 1) {
      lastPosition = widget.publicationController.pageChangeHistory[
          widget.publicationController.pageChangeHistory.length - 2];
    }
